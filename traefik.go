// Package traefik provides a consult registry with raw tags
package traefik
...
func init() {
	cmd.DefaultRegistries["traefik"] = NewRegistry
}

func (c *traefikRegistry) Deregister(s *registry.Service) error {
	if len(s.Nodes) == 0 {
...
func (c *traefikRegistry) Register(s *registry.Service, opts ...registry.RegisterOption) error {
	if len(s.Nodes) == 0 {
		return errors.New("Require at least one node")
	}
...
func (c *traefikRegistry) GetService(name string) ([]*registry.Service, error) {
...
func (c *traefikRegistry) ListServices() ([]*registry.Service, error) {
...
func (c *traefikRegistry) Watch() (registry.Watcher, error) {
	return newConsulWatcher(c)
}

func (c *traefikRegistry) String() string {
	return "consul"
}
